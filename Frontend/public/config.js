...
window.configs = {
    ...
    apiUrl: (isLocalhost && isDevelopment) 
        ...
        : 'https://aa154534-bca8-4dd3-a52e-51387c5d6859.e1-us-east-azure.choreoapps.dev/choreo-apis/sri-ko-lms-platform/backend/v1', // Choreo deployment with working URL
    featureFlags: {
