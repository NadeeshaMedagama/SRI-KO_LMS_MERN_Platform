            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium mt-2 ${getRoleBadgeColor(profileData.role)}`}>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <div className="flex flex-wrap gap-4">
                      ...
                      {!profileData.socialLinks.linkedin && !profileData.socialLinks.twitter && !profileData.socialLinks.github && (
